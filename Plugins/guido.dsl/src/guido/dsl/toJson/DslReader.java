 ...
 */
	public static void main(String[] args) {
		...
		for(String file: args) {
			...
			guido.core.statistics.Hypothesis hyp = fillHypothesis(dsl);
	 ...
	 * @return
	 */
	static guido.core.statistics.Hypothesis fillHypothesis(Dsl dsl){
		...
		return new guido.core.statistics.Hypothesis(
